...
one.pack(fill=X)
two = Label(root, text="To Lame Music Player", bg="white",fg="blue")
two.pack(fill=X)
three = Label(root, text="Created By Prajwal", bg="green",fg="white")
three.pack(fill=X)
...
root.screenMessage.set("Welcome, to Lame Music Player")
